 ...
 * @author Avaya Inc
 */
public abstract class AODialClickToCall extends MobileVideoActivity {

    private static final String TAG = AODialClickToCall.class.getSimpleName();

    private Logger mLogger = Logger.getLogger(TAG);

    private String mServer = "";
    //    private Class<? extends AOCallActivityImpl> mCallActivityClass;
    private Class<? extends AOClickToCall> mCallActivityClass;
...
//    protected void setCallActivityClass(Class<? extends AOCallActivityImpl> callActivityClass) {
    protected void setCallActivityClass(Class<? extends AOClickToCall> callActivityClass) {
