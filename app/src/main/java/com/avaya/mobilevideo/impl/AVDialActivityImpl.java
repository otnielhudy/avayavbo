...
public abstract class AVDialActivityImpl extends MobileVideoActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final String TAG = AVDialActivityImpl.class.getSimpleName();
     ...
     */
    protected void setCallActivityClass(Class<? extends AVCallActivityImpl> callActivityClass) {
