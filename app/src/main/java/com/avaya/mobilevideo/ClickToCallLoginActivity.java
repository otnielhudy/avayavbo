 ...
 * @author Avaya Inc
 */
public class ClickToCallLoginActivity extends LoginActivityImpl implements LoginActivity {
    ...
    protected void setReferencedClass() {
        if (!isAudioDesired) {
            setDialActivityClass(ClickToCallDialActivity.class);
            ManualSessionActivity.setDialActivityClass(ClickToCallDialActivity.class);
        } else {
